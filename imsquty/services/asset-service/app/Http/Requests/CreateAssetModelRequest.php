...
/**
 * Create AssetModel Request
 * 
 * Validation rules for creating a new asset model.
 */
class CreateAssetModelRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'asset_model' => 'required|string|max:255|unique:asset_models,asset_model',
