...
export const fetchManufacturers = createAsyncThunk('manufacturer/fetchManufacturers', async ({ page = 1, perPage = 50, filters = {} } = {}, { rejectWithValue }) => {
    try {
        const response = await manufacturerService.getManufacturers(page, perPage, filters);
        return response;
    }
    catch (error) {
...
export const fetchActiveManufacturers = createAsyncThunk('manufacturer/fetchActiveManufacturers', async (_, { rejectWithValue }) => {
    try {
