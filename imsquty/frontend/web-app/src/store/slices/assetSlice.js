...
export const fetchAssets = createAsyncThunk('asset/fetchAssets', async ({ page = 1, perPage = 10, filters = {} } = {}, { rejectWithValue }) => {
    try {
...
export const fetchAsset = createAsyncThunk('asset/fetchAsset', async (id, { rejectWithValue }) => {
    try {
...
export const createAsset = createAsyncThunk('asset/createAsset', async (data, { rejectWithValue }) => {
    try {
...
export const updateAsset = createAsyncThunk('asset/updateAsset', async ({ id, data }, { rejectWithValue }) => {
    try {
...
export const deleteAsset = createAsyncThunk('asset/deleteAsset', async (id, { rejectWithValue }) => {
    try {
