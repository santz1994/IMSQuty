...
import { Location, locationService } from '../../api/locationService'
...
const locationSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(fetchLocations.rejected, (state, action: any) => {
        state.loading = false
    ...
    builder
      ...
      .addCase(fetchActiveLocations.fulfilled, (state, action: any) => {
        state.loading = false
        state.locations = action.payload.data || []
      })
      .addCase(fetchActiveLocations.rejected, (state, action: any) => {
        state.loading = false
        state.error = action.payload
      })
  },
