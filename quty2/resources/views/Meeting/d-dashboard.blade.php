                ...
                <div class="box-body">
                    <div class="timeline-container" style="position: relative; min-height: 800px; overflow-y: auto; background: #f9f9f9; border-radius: 6px; padding: 15px;">
                        @php
                            ...
                            $rooms = ['Ruang Meeting 1', 'Ruang Meeting 2', 'Ruang Meeting 3'];
                            $roomColors = [
                        ...
                        <div style="position: relative;">
                            ...
                            @foreach($rooms as $roomIndex => $room)
                                @php
                                    ...
                                    $columnLeftOffset = 100 + ($roomIndex * 33.33); // Percentage based on room column
                                @endphp
                                ...
                                @foreach($roomBookings as $booking)
                                    ...
                                    <div class="timeline-booking" 
                                         style="position: absolute; 
                                                left: calc(100px + (100% - 100px) / 3 * {{ $roomIndex }} + 8px); 
