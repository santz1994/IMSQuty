...
**Copy-paste prompts untuk development imsquty Microservices**
...
### 1. Service Design
```
I'm building [SERVICE_NAME] service for imsquty microservices project. 
Reference: D:/Project/imsquty/quty2/docs/task/02_ARSITEKTUR_DETAIL_MICROSERVICES.md
...
Requirements:
- Follow imsquty naming conventions
...
Reference format from: D:/Project/imsquty/quty2/.github/copilot-instructions.md
```
...
```
Generate docker-compose.yml for imsquty microservices project.
...
Reference architecture: D:/Project/imsquty/quty2/docs/task/02_ARSITEKTUR_DETAIL_MICROSERVICES.md
```
...
### 16. React Component
```
Generate React component for [COMPONENT_NAME] in imsquty web app.
...
### 17. Redux Slice
```
Generate Redux Toolkit slice for [FEATURE_NAME] in imsquty web app.
...
Reference structure: D:/Project/imsquty/quty2/docs/task/07_PROJECT_STRUCTURE_COMPLETE.md
```
...
Source:
- Database: imsquty_monolith
- Tables: [table1, table2, table3]
- Records: ~[NUMBER] records

Target:
- Database: imsquty_microservices (shared)
...
Reference strategy: D:/Project/imsquty/quty2/docs/task/04_DATABASE_STRATEGY.md
