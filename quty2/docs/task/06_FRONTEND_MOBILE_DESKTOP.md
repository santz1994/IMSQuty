...
**Proyek:** imsquty Multi-Platform Applications  
...
class ApiClient {
  ...
  ApiClient({String? baseUrl})
      : _dio = Dio(BaseOptions(
          baseUrl: baseUrl ?? 'http://api.imsquty.com/api/v1',
...
function createTray() {
  ...
  tray.setToolTip('imsquty Asset Management');
...
{
  "appId": "com.imsquty.assetmanagement",
  "productName": "imsquty Asset Management",
  "directories": {
    "output": "release",
...
# Output: release/imsquty Setup 1.0.0.exe

# Build for Mac
npm run electron:build:mac
# Output: release/imsquty-1.0.0.dmg

# Build for Linux
npm run electron:build:linux
# Output: release/imsquty-1.0.0.AppImage
