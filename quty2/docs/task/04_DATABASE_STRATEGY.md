...
**Proyek:** imsquty Microservices Migration  
...
config:
  ...
  database.server.name: imsquty
  database.whitelist: auth_db,asset_db,ticket_db
  database.history.kafka.bootstrap.servers: kafka:9092
  database.history.kafka.topic: schema-changes.imsquty
