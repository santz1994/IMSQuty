# Arsitektur Detail Microservices - imsquty System
...
Arsitektur microservices imsquty dirancang dengan prinsip:
...
services:
  # API Gateway
  api-gateway:
    image: imsquty/api-gateway:latest
    ports:
      - "8000:8000"
    networks:
      - imsquty-network
  ...
  # Auth Service
  auth-service:
    image: imsquty/auth-service:latest
    ports:
      - "8001:8001"
    environment:
      - DB_HOST=mysql-auth
  ...
  # Asset Service
  asset-service:
    image: imsquty/asset-service:latest
    ports:
      - "8003:8003"
    environment:
      - DB_HOST=mysql-asset
